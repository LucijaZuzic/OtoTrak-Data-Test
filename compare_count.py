        ...
        for some_file in all_files:  
            ...
            for x in range(0, len(longitudes) - window_size + 1, step_size):
                ...
                for value_for_dict in range(len(name_val)):   
                    ...
                    intersections, distances, distancesx, distancesy = all_distances_trajs_other[x][name_val[value_for_dict]]  
                    all_nums_trajs[x][name_val[value_for_dict]] = count_in_matrix(intersections)
                    
                    intersections_preprocessed_trajs, distances_preprocessed_trajs, distancesx_preprocessed_trajs, distancesy_preprocessed_trajs = all_distances_preprocessed_trajs_other[x][name_val[value_for_dict]]  
                    all_nums_preprocessed_trajs[x][name_val[value_for_dict]] = count_in_matrix(intersections_preprocessed_trajs)

                    intersections_scaled_trajs, distances_scaled_trajs, distancesx_scaled_trajs, distancesy_scaled_trajs = all_distances_scaled_trajs_other[x][name_val[value_for_dict]]
                    all_nums_scaled_trajs[x][name_val[value_for_dict]] = count_in_matrix(intersections_scaled_trajs)

                    intersections_scaled_to_max, distances_scaled_to_max, distancesx_scaled_to_max, distancesy_scaled_to_max = all_distances_scaled_to_max_trajs_other[x][name_val[value_for_dict]]
                    all_nums_scaled_to_max_trajs[x][name_val[value_for_dict]] = count_in_matrix(intersections_scaled_to_max)
                    ...
                    print(ni, ni_pre, ni_scale, ni_scale_max) 
                    print(all_nums_trajs[x][name_val[value_for_dict]], all_nums_preprocessed_trajs[x][name_val[value_for_dict]], all_nums_scaled_trajs[x][name_val[value_for_dict]], all_nums_scaled_to_max_trajs[x][name_val[value_for_dict]])
