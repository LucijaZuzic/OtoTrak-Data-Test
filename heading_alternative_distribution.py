...
if flag_replace or not os.path.isfile("num_occurences/num_occurences_of_direction_alternative"):
    ...
    probability_of_direction_alternative, probability_of_direction_alternative_in_next_step, probability_of_direction_alternative_in_next_next_step = fix_prob(num_occurences_of_direction_alternative, num_occurences_of_direction_alternative_in_next_step, num_occurences_of_direction_alternative_in_next_next_step)
...
x = predict_prob(probability_of_direction_alternative, probability_of_direction_alternative_in_next_step, probability_of_direction_alternative_in_next_next_step, 0, 359, 1)
...
for subdir_name in all_subdirs: 
    ...
    for some_file in all_files:  
        ...
        x, n, match_score, no_empty, delta_series = predict_prob_with_array(probability_of_direction_alternative, probability_of_direction_alternative_in_next_step, probability_of_direction_alternative_in_next_next_step, direction_alternative_int, 0, 359, 1, isangle = True)
        total_guesses += n
