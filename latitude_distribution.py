...
if flag_replace or not os.path.isfile("num_occurences/num_occurences_of_latitude"):
    ...
    save_object("num_occurences/num_occurences_of_latitude", num_occurences_of_latitude)
    ...
    save_object("num_occurences/num_occurences_of_latitude_in_next_step", num_occurences_of_latitude_in_next_step)
    #print(num_occurences_of_latitude_in_next_next_step)
    save_object("num_occurences/num_occurences_of_latitude_in_next_next_step", num_occurences_of_latitude_in_next_next_step)

    probability_of_latitude, probability_of_latitude_in_next_step, probability_of_latitude_in_next_next_step = fix_prob(num_occurences_of_latitude, num_occurences_of_latitude_in_next_step, num_occurences_of_latitude_in_next_next_step)
    #print(probability_of_latitude)
    save_object("probability/probability_of_latitude", probability_of_latitude)
    #print(probability_of_latitude_in_next_step)
    save_object("probability/probability_of_latitude_in_next_step", probability_of_latitude_in_next_step)
    #print(probability_of_latitude_in_next_next_step)
    save_object("probability/probability_of_latitude_in_next_next_step", probability_of_latitude_in_next_next_step)
...
x = predict_prob(probability_of_latitude, probability_of_latitude_in_next_step, probability_of_latitude_in_next_next_step, 0, 1, 10 ** -10)
...
for subdir_name in all_subdirs: 
    ...
    for some_file in all_files:  
        ...
        x, n, match_score, no_empty, delta_series = predict_prob_with_array(probability_of_latitude, probability_of_latitude_in_next_step, probability_of_latitude_in_next_next_step, latitude_int, 0, 1, 10 ** -10)
        total_guesses += n
...
save_object("predicted/predicted_latitude", all_x)
