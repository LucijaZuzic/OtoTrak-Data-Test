...
if flag_replace or not os.path.isfile("num_occurences/num_occurences_of_y_speed_alternative"):
    ...
    for subdir_name in all_subdirs: 
        ...
        for some_file in all_files:  
            ...
            distance_int = [abs(latitudes[distance_index + 1] - latitudes[distance_index]) for distance_index in range(len(longitudes) - 1)]
    ...
    save_object("num_occurences/num_occurences_of_y_speed_alternative", num_occurences_of_y_speed_alternative)
    ...
    save_object("num_occurences/num_occurences_of_y_speed_alternative_in_next_step", num_occurences_of_y_speed_alternative_in_next_step)
    #print(num_occurences_of_y_speed_alternative_in_next_next_step)
    save_object("num_occurences/num_occurences_of_y_speed_alternative_in_next_next_step", num_occurences_of_y_speed_alternative_in_next_next_step)

    probability_of_y_speed_alternative, probability_of_y_speed_alternative_in_next_step, probability_of_y_speed_alternative_in_next_next_step = fix_prob(num_occurences_of_y_speed_alternative, num_occurences_of_y_speed_alternative_in_next_step, num_occurences_of_y_speed_alternative_in_next_next_step)
    #print(probability_of_y_speed_alternative)
    save_object("probability/probability_of_y_speed_alternative", probability_of_y_speed_alternative)
    #print(probability_of_y_speed_alternative_in_next_step)
    save_object("probability/probability_of_y_speed_alternative_in_next_step", probability_of_y_speed_alternative_in_next_step)
    #print(probability_of_y_speed_alternative_in_next_next_step)
    save_object("probability/probability_of_y_speed_alternative_in_next_next_step", probability_of_y_speed_alternative_in_next_next_step)
...
x =  predict_prob(probability_of_y_speed_alternative, probability_of_y_speed_alternative_in_next_step, probability_of_y_speed_alternative_in_next_next_step, 0, 1, 10 ** -5)
...
for subdir_name in all_subdirs: 
    ...
    for some_file in all_files:  
        ...
        x, n, match_score, no_empty, delta_series = predict_prob_with_array(probability_of_y_speed_alternative, probability_of_y_speed_alternative_in_next_step, probability_of_y_speed_alternative_in_next_next_step, y_speed_alternative_int, 0, 1, 10 ** -5)
        total_guesses += n
...
save_object("predicted/predicted_y_speed_alternative", all_x)
