...
if flag_replace or not os.path.isfile("num_occurences/num_occurences_of_x_speed_alternative"):
    ...
    probability_of_x_speed_alternative, probability_of_x_speed_alternative_in_next_step, probability_of_x_speed_alternative_in_next_next_step = fix_prob(num_occurences_of_x_speed_alternative, num_occurences_of_x_speed_alternative_in_next_step, num_occurences_of_x_speed_alternative_in_next_next_step)
...
x =  predict_prob(probability_of_x_speed_alternative, probability_of_x_speed_alternative_in_next_step, probability_of_x_speed_alternative_in_next_next_step, 0, 1, 10 ** -5)
...
for subdir_name in all_subdirs: 
    ...
    for some_file in all_files:  
        ...
        x, n, match_score, no_empty, delta_series = predict_prob_with_array(probability_of_x_speed_alternative, probability_of_x_speed_alternative_in_next_step, probability_of_x_speed_alternative_in_next_next_step, x_speed_alternative_int, 0, 1, 10 ** -5)
        total_guesses += n
