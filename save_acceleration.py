...
for subdir_name in all_subdirs:
    ...
    for some_file in all_files:  
        ...
        for x in range(0, len(longitudes) - window_size + 1, step_size):
            ...
            x_acceler_trajs = return_acceler_speeds(x_speeds_trajs, times_tmp_transform)
            y_acceler_trajs = return_acceler_speeds(y_speeds_trajs, times_tmp_transform)
            x_acceler_abs_trajs = return_acceler_speeds(abs_x_speeds_trajs, times_tmp_transform, True)
            y_acceler_abs_trajs = return_acceler_speeds(abs_y_speeds_trajs, times_tmp_transform, True)
            ...
            accelers_scaled_trajs = return_acceler_speeds(speeds_scaled_trajs, times_tmp_transform)
            ...
            accelers_abs_scaled_trajs = return_acceler_speeds(speeds_scaled_trajs, times_tmp_transform, True) 
            avg_acceler_abs_scaled_trajs = sum(accelers_abs_scaled_trajs) / len(accelers_abs_scaled_trajs)
            
            accelers_ototrak_scaled_trajs = return_acceler_speeds(speeds_tmp, times_tmp_transform) 
            ...
            accelers_abs_ototrak_scaled_trajs = return_acceler_speeds(speeds_tmp, times_tmp_transform, True) 
            ...
            x_acceler_scaled_trajs = return_acceler_speeds(x_speeds_scaled_trajs, times_tmp_transform)
            y_acceler_scaled_trajs = return_acceler_speeds(y_speeds_scaled_trajs, times_tmp_transform)
            x_acceler_abs_scaled_trajs = return_acceler_speeds(abs_x_speeds_scaled_trajs, times_tmp_transform, True)
            y_acceler_abs_scaled_trajs = return_acceler_speeds(abs_y_speeds_scaled_trajs, times_tmp_transform, True)
            ...
            accelers_scaled_to_max_trajs = return_acceler_speeds(speeds_scaled_to_max_trajs, times_tmp_transform)
            ...
            accelers_abs_scaled_to_max_trajs = return_acceler_speeds(speeds_scaled_to_max_trajs, times_tmp_transform, True) 
            avg_acceler_abs_scaled_to_max_trajs = sum(accelers_abs_scaled_to_max_trajs) / len(accelers_abs_scaled_to_max_trajs)
            
            accelers_ototrak_scaled_to_max_trajs = return_acceler_speeds(speeds_tmp, times_tmp_transform) 
            ...
            accelers_abs_ototrak_scaled_to_max_trajs = return_acceler_speeds(speeds_tmp, times_tmp_transform, True) 
            ...
            x_acceler_scaled_to_max_trajs = return_acceler_speeds(x_speeds_scaled_to_max_trajs, times_tmp_transform)
            y_acceler_scaled_to_max_trajs = return_acceler_speeds(y_speeds_scaled_to_max_trajs, times_tmp_transform)
            x_acceler_abs_scaled_to_max_trajs = return_acceler_speeds(abs_x_speeds_scaled_to_max_trajs, times_tmp_transform, True)
            y_acceler_abs_scaled_to_max_trajs = return_acceler_speeds(abs_y_speeds_scaled_to_max_trajs, times_tmp_transform, True)
