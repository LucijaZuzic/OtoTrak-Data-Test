...
if not os.path.isfile("num_occurences_of_speed_alternative"):
    ...
    for subdir_name in all_subdirs: 
        ...
        for some_file in all_files:  
            ...
            speed_alternative_int = [np.round(distance_int[speed_alternative_index] / times_delays[speed_alternative_index], 10) for speed_alternative_index in range(len(times_delays))]
...
for subdir_name in all_subdirs: 
    ...
    for some_file in all_files:  
        ...
        #plt.show()
save_object("predicted_speed_alternative", x)
