...
if not os.path.isfile("num_occurences/num_occurences_of_y_speed_no_abs_alternative"):
    ...
    save_object("num_occurences/num_occurences_of_y_speed_no_abs_alternative", num_occurences_of_y_speed_no_abs_alternative)
    ...
    save_object("num_occurences/num_occurences_of_y_speed_no_abs_alternative_in_next_step", num_occurences_of_y_speed_no_abs_alternative_in_next_step)
    ...
    save_object("probability/probability_of_y_speed_no_abs_alternative_in_next_step", probability_of_y_speed_no_abs_alternative_in_next_step)
    #print(probability_of_y_speed_no_abs_alternative_in_next_next_step)
    save_object("probability/probability_of_y_speed_no_abs_alternative_in_next_next_step", probability_of_y_speed_no_abs_alternative_in_next_next_step)
